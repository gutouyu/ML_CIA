...
class PNN1(Model):
    def __init__(self, field_sizes=None, embed_size=10, layer_sizes=None, layer_acts=None, drop_out=None,
        ...
        node_in = num_inputs * embed_size + num_pairs # 第一个隐藏层的输入维度，难道这就是lz lp吗？合着lz的要更大一些，以为是k * pairs, lp只是pairs，也就是lp一个pair生成一个值，lz一个pair生成一个embedding大小? 是这意思吗
        ...
        with self.graph.as_default():
            ...
            xw3d = tf.reshape(xw, [-1, num_inputs, embed_size]) # 为什么要转换成3d的那? [num_samples, num_field, embed_sz]
